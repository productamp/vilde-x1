...
contextBridge.exposeInMainWorld("desktopApi", {
  ...
  getProductVibeMode: () => ipcRenderer.invoke("app:get-product-vibe-mode") as Promise<boolean>,
  setProductVibeMode: (enabled: boolean) =>
    ipcRenderer.invoke("app:set-product-vibe-mode", enabled) as Promise<boolean>,
...
export interface DesktopApi {
  ...
  getProductVibeMode: () => Promise<boolean>
  setProductVibeMode: (enabled: boolean) => Promise<boolean>
  // Auto-update
