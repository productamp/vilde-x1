          ...
          },
          {
            onData: (chunk: UIMessageChunk) => {
              ...
              if (chunk.type === "auth-error") {
                const productVibeMode = appStore.get(productVibeModeAtom)
                ...
                if (productVibeMode) {
                  ...
                  console.log(`[SD] R:AUTH_ERR_PRODUCTVIBE sub=${subId}`)
                  controller.error(new Error("Claude authentication required"))
                  return
                }
